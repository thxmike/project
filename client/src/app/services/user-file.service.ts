...
export class UserFileApiService extends BaseHttpService<File> {
  ...
  public deleteFileOrFolder(userId: string, fileOrFolder: Partial<File>): Observable<any> {
  ...
  public updateFile(userId: string, fileId: string, partialUpdate: Partial<File>): Observable<File> {
